  ...
  return function (Module) {
    ...
    (function () {
      var loadPackage = function (metadata) {
        ...
        var PACKAGE_NAME = "D:/Projects/dev/wasmDoom/wasm-doom/doom.data";
        ...
        function runWithFS() {
          ...
          function processPackageData(arrayBuffer) {
            ...
            Module["removeRunDependency"](
              "datafile_D:/Projects/dev/wasmDoom/wasm-doom/doom.data",
            );
          }
      ...
      loadPackage({
        files: [{ filename: "/DOOM.WAD", start: 0, end: 11159840, audio: 0 }],
        remote_package_size: 11159840,
        package_uuid: "dc6dd411-f1db-4390-a640-34b505b85d7c",
      });
    })();
    var moduleOverrides = {};
    var key;
    ...
    var DYNAMIC_BASE = 7712784,
      DYNAMICTOP_PTR = 2469872;
      ...
      function ($0, $1) {
        document.dispatchEvent(
          new CustomEvent("P_KillMobj", {
            detail: { mapname: UTF8ToString($0), source: UTF8ToString($1) },
          }),
        );
      },
      function () {
      ...
      function ($0) {
        document.dispatchEvent(
          new CustomEvent("I_Error", {
            detail: { errorMsg: UTF8ToString($0) },
          }),
        );
      },
      function () {
    ...
    var ___tm_current = 2469728;
    var ___tm_timezone = (stringToUTF8("GMT", 2469776, 4), 2469776);
    function _tzset() {
    ...
    var asmLibraryArg = {
      ...
      C: _emscripten_get_gamepad_status,
      ...
      Hd: _emscripten_glBindVertexArrayOES,
      qd: _emscripten_glBlendColor,
      pd: _emscripten_glBlendEquation,
      od: _emscripten_glBlendEquationSeparate,
      nd: _emscripten_glBlendFunc,
      md: _emscripten_glBlendFuncSeparate,
      ld: _emscripten_glBufferData,
      kd: _emscripten_glBufferSubData,
      jd: _emscripten_glCheckFramebufferStatus,
      id: _emscripten_glClear,
      hd: _emscripten_glClearColor,
      fd: _emscripten_glClearDepthf,
      ed: _emscripten_glClearStencil,
      dd: _emscripten_glColorMask,
      cd: _emscripten_glCompileShader,
      bd: _emscripten_glCompressedTexImage2D,
      ad: _emscripten_glCompressedTexSubImage2D,
      $c: _emscripten_glCopyTexImage2D,
      _c: _emscripten_glCopyTexSubImage2D,
      Zc: _emscripten_glCreateProgram,
      Yc: _emscripten_glCreateShader,
      ...
      Gd: _emscripten_glDeleteVertexArraysOES,
      ...
      Dd: _emscripten_glDrawBuffersWEBGL,
      ...
      Fd: _emscripten_glGenVertexArraysOES,
      ...
      Jd: _emscripten_glGetQueryObjecti64vEXT,
      Ld: _emscripten_glGetQueryObjectivEXT,
      Id: _emscripten_glGetQueryObjectui64vEXT,
      Kd: _emscripten_glGetQueryObjectuivEXT,
      Md: _emscripten_glGetQueryivEXT,
      ...
      Ed: _emscripten_glIsVertexArrayOES,
      Jb: _emscripten_glLineWidth,
      Ib: _emscripten_glLinkProgram,
      Hb: _emscripten_glPixelStorei,
      Gb: _emscripten_glPolygonOffset,
      _: _emscripten_glQueryCounterEXT,
      Fb: _emscripten_glReadPixels,
      Eb: _emscripten_glReleaseShaderCompiler,
      Db: _emscripten_glRenderbufferStorage,
      Cb: _emscripten_glSampleCoverage,
      Bb: _emscripten_glScissor,
      ...
      Mb: _emscripten_set_main_loop,
      W: _emscripten_set_mousedown_callback_on_thread,
      U: _emscripten_set_mouseenter_callback_on_thread,
      T: _emscripten_set_mouseleave_callback_on_thread,
      X: _emscripten_set_mousemove_callback_on_thread,
      V: _emscripten_set_mouseup_callback_on_thread,
      L: _emscripten_set_pointerlockchange_callback_on_thread,
      G: _emscripten_set_resize_callback_on_thread,
      M: _emscripten_set_touchcancel_callback_on_thread,
      O: _emscripten_set_touchend_callback_on_thread,
      N: _emscripten_set_touchmove_callback_on_thread,
      P: _emscripten_set_touchstart_callback_on_thread,
    ...
    var _I_UpdateMouseButtonState = (Module["_I_UpdateMouseButtonState"] =
      function () {
    ...
    var _I_WEB_RegisterSongFallback = (Module["_I_WEB_RegisterSongFallback"] =
      function () {
